                            ...
                            <div className="mb-4">
                                ...
                                <div className="row g-3">
                                    <div className="col-md-4">
                                        ...
                                        <input type="text" name="portName" className="form-control qt-input" placeholder="Enter PortName" value={formData.portName} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Port Code <span className="text-danger">*</span></label>
                                        <input type="text" name="portCode" className="form-control qt-input" placeholder="Enter PortCode" value={formData.portCode} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Country <span className="text-danger">*</span></label>
                                        <select name="country" className="form-control qt-input" value={formData.country} onChange={handleFormChange}>
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <select name="timeZone" className="form-control qt-input" value={formData.timeZone} onChange={handleFormChange}>
                                            <option value="">Select TimeZone</option>
                                        </select>
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">State / Province <span className="text-danger">*</span></label>
                                        <input type="text" name="stateProvince" className="form-control qt-input" value={formData.stateProvince} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Trade Line</label>
                                        <select name="tradeLine" className="form-control qt-input" value={formData.tradeLine} onChange={handleFormChange}>
                                            <option value="">--Select TradeLine--</option>
                                        </select>
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">IATA</label>
                                        <input type="text" name="iata" className="form-control qt-input" placeholder="Enter IATA Code" value={formData.iata} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">UNECE Code <span className="text-danger">*</span></label>
                                        <input type="text" name="uneceCode" className="form-control qt-input" placeholder="Enter UNECE Code" value={formData.uneceCode} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Coordinates</label>
                                        <input type="text" name="coordinates" className="form-control qt-input" placeholder="Enter Coordinates" value={formData.coordinates} onChange={handleFormChange} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="row g-3">
                                    <div className="col-md-4">
                                        ...
                                        <input type="text" name="schedKCode" className="form-control qt-input" placeholder="Sched-K Code" value={formData.schedKCode} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Sched-D Code (Airport)</label>
                                        <input type="text" name="schedDCodeAirport" className="form-control qt-input" placeholder="Sched-D Code (Airport)" value={formData.schedDCodeAirport} onChange={handleFormChange} />
                                    </div>
                                    <div className="col-md-4">
                                        <label className="qt-label">Sched-D Code (Seaport)</label>
                                        <input type="text" name="schedDCodeSeaport" className="form-control qt-input" placeholder="Sched-D Code (Seaport)" value={formData.schedDCodeSeaport} onChange={handleFormChange} />
                                    </div>
                                </div>
                            </div>
                        </div>
