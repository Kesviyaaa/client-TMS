...
// ───── Main Component ─────
const OceanImportSalesPerformance = () => {
        ...
        <div className="container-xxl flex-grow-1 container-p-y pb-5">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h5 className="perf-header-title text-uppercase">
                    <span className="text-muted pe-1">DASHBOARD</span> <span className="perf-ocean-import">SALES PERFORMANCE</span>
                </h5>
...
export default OceanImportSalesPerformance;
