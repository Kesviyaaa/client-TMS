...
const SalesTable = ({ title, activeMainTab }) => {
    ...
    useEffect(() => {
        ...
        dtRef.current = $(tableRef.current).DataTable({
            ...
            data: [],
            columns: [
                { data: "salesPerson", title: "Sales Person", defaultContent: "" },
                { data: "noOfShipments", title: "Number Of Shipments", defaultContent: "" },
                { data: "totalWeight", title: "Totalweight", defaultContent: "" },
            ],
            pagingType: "simple",
        });
...
// ───── Main Component ─────
const OceanExportSalesPerformance = () => {
        ...
        <div className="container-xxl flex-grow-1 container-p-y pb-5">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h5 className="perf-header-title text-uppercase">
                    <span className="text-muted pe-1">DASHBOARD</span> <span className="perf-ocean-export">SALES PERFORMANCE</span>
                </h5>
...
export default OceanExportSalesPerformance;
