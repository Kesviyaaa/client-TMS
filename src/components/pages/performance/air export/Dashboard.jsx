    ...
    <div className="container-xxl flex-grow-1 container-p-y pb-5">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5 className="perf-header-title text-uppercase">
          <span className="text-muted pe-1">DASHBOARD</span> <span className="perf-air-export">AIR EXPORT</span>
        </h5>
        ...
        <div className="d-flex align-items-center gap-3">
           ...
           <div className="d-flex align-items-center gap-2">
              <input type="date" className="header-filter-input" defaultValue="2026-03-29" />
      ...
      <div className="row g-3 mb-4">
        <div className="col-md-3">
           <BracketCard className="p-3 h-100">
              ...
              <div className="kpi-text">
                 <i className="bx bx-target-lock text-secondary"></i>
        ...
        <div className="col-md-3">
           <BracketCard className="p-3 h-100">
              <div className="kpi-title">NO OF CUSTOMER</div>
              <div className="kpi-text"><i className="bx bx-buildings text-secondary"></i> Last month performer</div>
              <div className="kpi-text"><i className="bx bx-stats text-secondary"></i> Total Chargeable Weight(in Kgs)</div>
           </BracketCard>
        </div>
        <div className="col-md-3">
           <BracketCard className="p-3 h-100">
              ...
              <div className="kpi-text"><i className="bx bx-menu text-secondary"></i> Total Free Hand :</div>
...
export default AirExportDashboard;
