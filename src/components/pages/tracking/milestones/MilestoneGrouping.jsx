...
const dummyGroupings = [
    { _id: "1", groupName: "Export Agents Group", role: "Manager", description: "Handles all export agents" },
    { _id: "2", groupName: "Import Coordinators", role: "Coordinator", description: "Handles import logistics" }
];

const MilestoneGrouping = () => {
    const tableRef = useRef(null);
    const dtRef = useRef(null);

    const [view, setView] = useState("table"); // "table" | "form"
    const [groupings, setGroupings] = useState(dummyGroupings);
    ...
    const handleDeleteConfirm = () => {
        setGroupings(prev => prev.filter(m => m._id !== deleteId));
            ...
            <div className="container-xxl flex-grow-1 container-p-y">
                <div className="card">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h5 className="mb-0">Create Grouping</h5>
                        <button className="btn btn-secondary-custom" onClick={() => setView("table")}>Back to List</button>
                    </div>
                    <div className="card-body p-4">
                        <p className="text-muted">Form content for creating a milestone grouping would go here...</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="container-xxl container-p-y pb-5">
            ...
            <h4 className="table-title mb-4">Milestone Grouping</h4>

            <div className="ocean-card">
                <div className="ocean-title">
                    <span className="bk-section-title">
                        <div className="bk-icon-circle"><i className="bx bx-group"></i></div> Grouping List
                    </span>
                    <button className="btn-primary-custom" onClick={(e) => e.preventDefault()}>
                        <i className="bx bx-plus"></i> Create Grouping
                    </button>
                </div>
                ...
                <div className="custom-modal-backdrop">
                    <div className="custom-modal-card">
                        <div className="text-center p-4">
                            ...
                            <p className="text-muted mb-4">You want to delete this grouping? This action cannot be undone.</p>
...
export default MilestoneGrouping;
