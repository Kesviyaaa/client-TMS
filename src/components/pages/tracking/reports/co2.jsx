...
const co2Data = [
    {
        id: "1", shipmentNo: "SHIP-001", containerNo: "CONT-123", shipper: "ABC Logistics", consignee: "Global Freight",
        roadCO2: "125.50", oceanCO2: "450.75", totalCO2: "576.25"
    },
    {
        id: "2", shipmentNo: "SHIP-002", containerNo: "CONT-456", shipper: "Skyline Shipping", consignee: "Prime Cargo",
        roadCO2: "85.20", oceanCO2: "320.10", totalCO2: "405.30"
    }
];
...
const Co2Reports = () => {
    ...
    useEffect(() => {
        ...
        dtRef.current = $(tableRef.current).DataTable({
            ...
            scrollY: "400px",
            scrollCollapse: true,
            data: [], // Starting with empty as per screenshot "No data available in table"
            language: {
                lengthMenu: "Show _MENU_ entries",
                search: "Search:",
                emptyTable: "No data available in table",
                info: "Showing 0 to 0 of 0 entries",
            },
            buttons: [
                {
                    extend: "collection",
            ...
            columns: [
                ...
                { data: "roadCO2", title: "Road CO2(in Kg)." },
                { data: "oceanCO2", title: "Ocean CO2(in Kg)." },
                { data: "totalCO2", title: "Total CO2(In Kg)." }
            ]
        });

        // Remove default bootstrap classes from buttons to match AirShipment.jsx style
        setTimeout(() => {
                ...
                <div className="row g-3 px-4 pb-4 align-items-end">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="date-range-container">
                            <input type="date" className="filter-input" name="dateFrom" value={filters.dateFrom} onChange={handleFilterChange} />
                            <span className="text-muted">To</span>
                            <input type="date" className="filter-input" name="dateTo" value={filters.dateTo} onChange={handleFilterChange} />
                        </div>
                    </div>
                </div>
