...
const airlineData = [
    { 
        id: "1", branch: "New York (JFK)", shippingLine: "Emirates SkyCargo", 
        shipmentCount: "45", chargeableWeight: "12500" 
    },
    { 
        id: "2", branch: "London (LHR)", shippingLine: "Qatar Airways Cargo", 
        shipmentCount: "32", chargeableWeight: "8400" 
    }
];
    ...
    useEffect(() => {
        ...
        dtRef.current = $(tableRef.current).DataTable({
            ...
            columns: [
                ...
                { data: "chargeableWeight", title: "Chargeable Weight" }
            ]
        });
            ...
            <div className="ocean-card">
                <div className="ocean-title pb-1 m-0">
                    <span className="bk-section-title">
                        <div className="bk-icon-circle"><i className="bx bx-map-pin"></i></div> Airline Report
                    </span>
                </div>
